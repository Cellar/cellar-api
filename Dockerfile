FROM  gitlab.com/cellar-app/dependency_proxy/containers/golang:1.15-alpine3.12 as build
...
FROM gitlab.com/cellar-app/dependency_proxy/containers/alpine:3.12
